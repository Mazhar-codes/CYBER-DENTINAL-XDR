// mockData.ts — TypeScript version of mockData.js
// Used as fallback graph data until live Socket.IO events arrive
...
export const MOCK_GRAPH: GraphData = (() => {
  ...
  const RESPONSES: GraphData["RESPONSES"] = {
    "p-01": [
